...
public class OmniTechBlockEntities {
    ...
    public static final Supplier<BlockEntityType<AssemblerBlockEntity>> ASSEMBLER =
            REGISTRY.register("assembler",
                    () -> new BlockEntityType<>(AssemblerBlockEntity::new,
                            OmniTechBlocks.ASSEMBLER.get()));

    public static final Supplier<BlockEntityType<ReactorBlockEntity>> REACTOR =
    ...
    public static final Supplier<BlockEntityType<com.dev1lroot.mcmods.omnitech.blocks.labware.FermenterBlockEntity>> FERMENTER =
            REGISTRY.register("fermenter",
                    () -> new BlockEntityType<>(com.dev1lroot.mcmods.omnitech.blocks.labware.FermenterBlockEntity::new,
                            OmniTechBlocks.FERMENTER.get()));
