...
public class SolvationMachineScreen extends AbstractContainerScreen<SolvationMachineMenu> {
    ...
    // KF progress bar (below item slot)
    private static final int KF_BAR_X = 52, KF_BAR_Y = 58, KF_BAR_W = 72;

    public SolvationMachineScreen(SolvationMachineMenu menu, Inventory playerInventory, Component title) {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Input tank (left) — frame + fluid bar
        ...
        // Output tank (right) — frame + fluid bar
        ...
        // Item input slot
        GuiUtil.renderSlot(graphics, x + SolvationMachineMenu.SLOT_X, y + SolvationMachineMenu.SLOT_Y);
    ...
    protected void extractLabels(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        // KF progress (centered below the bar)
        ...
        // Output fluid (right side label — keep it short)
