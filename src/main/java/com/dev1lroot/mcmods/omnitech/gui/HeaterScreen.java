...
public class HeaterScreen extends AbstractContainerScreen<HeaterMenu> {
    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath(OmniTech.MODID, "textures/gui/heater.png");

    // Flame sprite: 14×14 at UV (176, 0) in the texture sheet
    ...
    // Heat gauge fill sprite: 12×52 at UV (176, 14)
    // Drawn from the bottom up based on storedHeat / maxHeat
    private static final int HEAT_FILL_U = 176, HEAT_FILL_V = 14;
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
        ...
        if (flameH > 0) {
            ...
            graphics.blit(RenderPipelines.GUI_TEXTURED, TEXTURE,
                    x + FLAME_X, y + FLAME_Y + yOff,
                    (float) FLAME_U, (float) (FLAME_V + yOff),
                    FLAME_W, flameH, 256, 256);
        }
