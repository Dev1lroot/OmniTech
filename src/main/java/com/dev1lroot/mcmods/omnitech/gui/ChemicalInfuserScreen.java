...
public class ChemicalInfuserScreen extends AbstractContainerScreen<ChemicalInfuserMenu> {

    private static final GuiLayout LAYOUT = GuiLayoutLoader.load("chemical_infuser");
    private GuiDataContext dataCtx;

    public ChemicalInfuserScreen(ChemicalInfuserMenu menu, Inventory playerInventory,
            Component title) {
