...
public class ElectricChargerScreen extends AbstractContainerScreen<ElectricChargerMenu> {

    private static final GuiLayout LAYOUT = GuiLayoutLoader.load("electric_charger");

    private GuiDataContext dataCtx;

    public ElectricChargerScreen(ElectricChargerMenu menu, Inventory playerInventory,
            Component title) {
