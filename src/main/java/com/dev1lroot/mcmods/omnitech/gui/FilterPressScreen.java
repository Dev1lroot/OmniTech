...
public class FilterPressScreen extends AbstractContainerScreen<FilterPressMenu> {

    private static final GuiLayout LAYOUT = GuiLayoutLoader.load("filter_press");
    private GuiDataContext dataCtx;

    public FilterPressScreen(FilterPressMenu menu, Inventory playerInventory, Component title) {
