...
public class OmniTechMenuTypes {
    ...
    public static final Supplier<MenuType<ReactorMenu>> REACTOR =
    ...
    public static final Supplier<MenuType<com.dev1lroot.mcmods.omnitech.gui.PressMenu>> PRESS =
            REGISTRY.register("press",
                    () -> IMenuTypeExtension.create(com.dev1lroot.mcmods.omnitech.gui.PressMenu::new));
    ...
    public static final Supplier<MenuType<com.dev1lroot.mcmods.omnitech.gui.FermenterMenu>> FERMENTER =
            REGISTRY.register("fermenter",
                    () -> IMenuTypeExtension.create(com.dev1lroot.mcmods.omnitech.gui.FermenterMenu::new));
